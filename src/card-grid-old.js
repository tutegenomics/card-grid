angular.module('cardGrid', ['iconPush'])
    ...
    .directive('cardGrid', function($window, $compile, $timeout) {
        ...
        var cardGridCtrl = function($scope, $element) {
            ...
            var cardTemplate = '<div class="card" card-grid-element></div>';
            ...
            $scope.grid = {
                init: function() {
                    ...
                    $timeout(function() {
                        $scope.cardElements[0].element.append('super<br>super<br>super<br>super<br>super<br>super<br>super<br>super<br>super<br>super<br>super<br>super<br>')
                    }, 3000)
            ...
            var resizeDebounce = _.debounce($scope.grid.resize.bind($scope.grid), 300);
